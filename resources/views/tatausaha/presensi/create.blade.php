...
@section('content')
    <h3 class="mb-3">Tambah Presensi Pegawai</h3>
...
<form method="POST" action="{{ route('tatausaha.presensi.store') }}" class="card p-4 shadow-sm border-0">
    @csrf
    ...
    <div class="mb-3">
        ...
        @php $st = old('status_presensi'); @endphp
