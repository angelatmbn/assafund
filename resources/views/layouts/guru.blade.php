...
<body>
    ...
    <aside>
        ...
        <div class="sidebar-title">Halaman Guru</div>
        <div class="sidebar-sub">Panel data kelas & presensi</div>
        ...
        <ul class="nav nav-pills flex-column gap-1">
            ...
            <li class="nav-item">
                <a href="{{ route('guru.gaji.index') }}"
                class="nav-link {{ request()->routeIs('guru.gaji.*') ? 'active' : '' }}">
                    Penggajian
    </a>
</li>
